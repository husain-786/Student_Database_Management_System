...
public class InsertNewResult extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/student_database_management_system/icons8-submit-document-32.png"))); // NOI18N
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        String SEPM = jTextField5.getText();
        String SMA = jTextField6.getText();
        ...
        try{
            ...
            ResultSet rs = st.executeQuery("select * from Student where RollNo = '"+ roll_no +"'");
            
            if (rs.next()){
                //st.executeUpdate("insert into result values ('" + roll_no + "','"+ OS + "','" + DBMS + "','" + DSA + "','" + SEPM + "','" + SMA + "','" + EM + "')");
                String query = String.format("insert into Result values (%s, %s, %s, %s, %s, %s, %s)", roll_no, OS, DBMS, DSA, SEPM, SMA, EM);
